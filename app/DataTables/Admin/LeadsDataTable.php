...
class LeadsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('next_follow_up_remark', function ($row) {
                return Str::limit($row->next_follow_up_remark, 50);
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('checkbox') // Add checkbox column
                ->exportable(false)
                ->printable(false)
                ->orderable(false)
                ->searchable(false)
                ...
                ->title('Select All <input type="checkbox" id="select-all">'),
