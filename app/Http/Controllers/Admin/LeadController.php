...
class LeadController extends AdminBaseController
{
    ...
    public function import(Request $request)
    {
       $requestData = $request->all();
        ...
        Excel::import(new LeadsImport($requestData, $leadStatus), $request->file('file'));
    ...
    public function bulkDelete(Request $request)
    {
        if ($request->has('ids')) {
            ...
            // Delete the leads with the given IDs
            Lead::whereIn('id', $ids)->delete();

            return response()->json(['success' => true, 'message' => 'Selected records have been deleted successfully.']);
        }
